				...
				<div class="m-card-profile">
					...
					<div class="m-card-profile__pic">
						<div class="m-card-profile__pic-wrapper">	
							<img src="images/app/media/img/users/user4.jpg" alt=""/>
						</div>
					</div>
				...
				<div class="tab-pane active" id="m_user_profile_tab_1">
					<form class="m-form m-form--fit m-form--label-align-right">
						<div class="m-portlet__body">
							...
							<div class="form-group m-form__group row">
								<label for="example-text-input" class="col-2 col-form-label">Acupacion</label>
								<div class="col-7">
									<input class="form-control m-input" type="text" value="Jefe de sistemas">
								</div>
							</div>
							<div class="form-group m-form__group row">
								<label for="example-text-input" class="col-2 col-form-label">Nombre compañia</label>
								<div class="col-7">
									<input class="form-control m-input" type="text" value="Kooning Travel">
									<!--<span class="m-form__help">If you want your invoices addressed to a company. Leave blank to use your full name.</span>-->
								</div>
							</div>
							<div class="form-group m-form__group row">
								<label for="example-text-input" class="col-2 col-form-label">Numero telefonico</label>
								<div class="col-7">
									<input class="form-control m-input" type="text" value="numero de kooning">
								</div>
							</div>
...
<!-- aqui termina todo tu codigo html -->
@stop